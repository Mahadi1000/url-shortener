...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Url-Shortener | Dashboard",
    description:
      "Unlock the power of concise links with Url-Shortener! 🚀 Transform long URLs into sleek, shareable gems effortlessly. Your dashboard is the control center, where simplicity meets analytics. Track clicks, manage your links, and navigate the world of streamlined URLs with ease. Url-Shortener: Link Shortening, Elevated. #URLShortener #TrixURL",
    type: "website",
  },
  twitter: {
    title: "Url-Shortener | Dashboard",
